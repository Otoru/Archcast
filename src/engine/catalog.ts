...
export const BLOCK_CATALOG: BlockPreset[] = [
  {
    ...
    primitive: "origin",
    layer: "client",
    defaults: { costPerInstance: 0, costPerCapacityUnit: 0 },
