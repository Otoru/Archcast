...
export const BLOCK_CATALOG: BlockPreset[] = [
  ...
  },
  {
    ...
    primitive: "server",
    layer: "edge",
    defaults: { capacity: 1e6, latBase: 5, availability: 0.9999 },
    flags: { weighted: true },
  ...
  },
  {
    ...
    primitive: "absorber-forwarding",
    layer: "edge",
    defaults: { hitRatio: 0.02, capacity: 5e4, latBase: 5 },
    flags: { drop: true },
    edges: { in: ["read", "write"], out: ["read", "write"] },
  },
  {
    ...
    primitive: "server",
    layer: "edge",
    defaults: { capacity: 2e4, latBase: 5, rateCap: 2e4 },
    edges: { in: ["read", "write"], out: ["read", "write"] },
  },
  {
    kind: "load-balancer",
    ...
    primitive: "server",
    layer: "edge",
    defaults: { capacity: 1e5, latBase: 1, availability: 0.9999 },
    edges: { in: ["read", "write"], out: ["read", "write"] },
  },
  {
    kind: "app-server",
    ...
    primitive: "server",
    layer: "compute",
    defaults: { capacity: 2000, latBase: 20, instances: 1, availability: 0.99 },
  ...
  },
  {
    ...
    primitive: "server",
    layer: "compute",
    defaults: { capacity: 3000, latBase: 15, availability: 0.99 },
    edges: { in: ["read", "write", "async"], out: ["read", "write", "async"] },
  },
  {
    kind: "serverless",
    ...
    primitive: "server",
    layer: "compute",
    defaults: { capacity: 1000, latBase: 50, availability: 0.9999 },
    flags: { elastic: true },
  ...
  },
  {
    ...
    primitive: "server",
    layer: "compute",
    defaults: { capacity: 1000, latBase: 100, instances: 1 },
  ...
  },
  {
    ...
    primitive: "server",
    layer: "compute",
    defaults: { capacity: 500, latBase: 500 },
    edges: { in: ["async"], out: ["write"] },
  },
  {
    kind: "auth-service",
    label: "Auth Service",
    primitive: "server",
    layer: "compute",
    defaults: { capacity: 5000, latBase: 30 },
    edges: { in: ["read", "write"], out: ["read", "write"] },
  },
  {
    kind: "sql-db",
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 5000, latBase: 5, instances: 1, availability: 0.999 },
    edges: { in: ["read", "write"], out: ["async"] },
  },
  {
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 2e4, latBase: 3, availability: 0.999 },
  ...
  },
  {
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 5e4, latBase: 2 },
    edges: { in: ["read", "write"], out: [] },
  },
  {
    kind: "wide-column",
    label: "Wide Column Database",
    primitive: "server",
    layer: "data",
    defaults: { capacity: 3e4, latBase: 4 },
    edges: { in: ["read", "write"], out: [] },
  },
  {
    kind: "timeseries-db",
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 1.5e4, latBase: 4 },
    edges: { in: ["read", "write"], out: [] },
  },
  {
    kind: "graph-db",
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 3000, latBase: 8 },
    edges: { in: ["read", "write"], out: [] },
  },
  {
    kind: "object-storage",
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 5e4, latBase: 30, availability: 0.99999 },
    edges: { in: ["read", "write"], out: [] },
  },
  {
    kind: "data-warehouse",
    ...
    primitive: "server",
    layer: "data",
    defaults: { capacity: 200, latBase: 2000 },
    edges: { in: ["read", "write"], out: [] },
  },
  {
    kind: "message-queue",
    ...
    layer: "messaging",
    defaults: { drainRate: 5000, maxDepth: 1e6, latBase: 5 },
  ...
  },
  {
    ...
    layer: "messaging",
    defaults: { capacity: 1e5, latBase: 5 },
    edges: { in: ["async"], out: ["async"] },
  },
  {
    kind: "event-bus",
